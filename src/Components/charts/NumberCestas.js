...
const NumberDoacoes = () => {
	const data=[
		...
		{x: new Date('September 4 2017'), y: 10},
		{x: new Date('September 5 2017'), y: 3},
		{x: new Date('September 6 2017'), y: 3},
		{x: new Date('September 7 2017'), y: 26},
